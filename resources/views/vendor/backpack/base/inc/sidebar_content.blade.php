...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('service') }}'><i class='nav-icon la la-folder-open'></i> Категория услуг</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('detail') }}'><i class='nav-icon la la-folder-plus'></i> Услуги</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('question') }}'><i class='nav-icon la la-book-open'></i> Вопрос/Ответ</a></li>
